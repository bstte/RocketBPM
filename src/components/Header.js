...
const Header = ({
  ...
  const contactInfo = pendingApproval?.contact_info || {};
  const ownerIds = [
    ...(contactInfo.owner || []),
    ...(contactInfo.domain_owner || [])
  ];
    ...
    <>
      <div style={styles.mainheader} className="ss_new_hed">
        ...
        >
          ...
          {/* APPROVAL BUTTONS – BESIDE BREADCRUMBS */}
        ...
        <div style={styles.mhcolright} className="ss_header_new_right">
          <div style={styles.loginuserbox} className="ss_hed_rit_user_secnew">
            ...
            {(Page === "ViewDraftmodel" || Page === "ViewDraftswimlane") && (
              <>
                {/* 1. EDIT MODEL / SCHEDULED EDIT */}
                {checkpublish === 0  // Assuming checkpublish logic or similar handles "Edit" enablement usually, but here relies on role
                  // Existing logic: Procesuser.role !== "User"
                }

                {/* Case: Pending Approval - Requester */}
              ...
              <>
                ...
                <div>
                  <button
                    ...
                    title={
                      !checkpublish ? "Publish all parent models first" : ""
                    }
                  >
                    {t("Publish")}
                  </button>
